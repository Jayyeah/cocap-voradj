...
# Lightweight scratch screening for VCT-LS + CE coverage experiments.
...
VCT-LS + CE coverage scratch screening
...
notes: batch summaries include CE coverage_success_rate plus coverage_cv015_rate / coverage_cv015_best_rate for loose cv<0.15 tracking.
EOF
