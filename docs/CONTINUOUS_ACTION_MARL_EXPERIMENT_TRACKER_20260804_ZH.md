...
> 建立日期：2026-08-04  
> 状态：ACTIVE_AXAY_AW_500K_PARALLEL_SCRATCH（六条 500k scratch 长训已启动；ax/ay 与 AW 各自 mix 非 global、pure coverage、global capture 并行；结果未出，不提前晋级）
> 当前阶段：BUG-04、BUG-05、BUG-06、BUG-07 与最小报告诊断字段已完成；formal matched 5k 双线均 finite 但 pure coverage 与 global capture 均 collision=100%、成功事件=0，按综合判据不晋级；当前六条长训只作数据积累，exact env-state resume 仍明确不支持。
...
| p6-axay-500k-pure-2026080515 | P6-long | 2026-08-05 23:26 start | formal P6, `scene_set=pure_coverage` | local | scratch | 0.8 | 2026081502 | 500000 requested; replay cap 100000; screens every 100000 | RTX A6000 GPU1 | running; step100000 at 2026-08-06 15:01; learning gate failed: rollout collision at step 14/16, end speed 3.0, CV 0/2 | `artifacts/2026-08-04_continuous_marl_refactor/p6_screening/p6_axay_500k_pure_coverage_20260805_*` | 100k 复盘见 8.2；继续 500k 数据积累，不晋级 |
...
| p6-aw-500k-pure-2026080516 | P6-long-bridge | 2026-08-05 23:35 start | formal P6, `action_mode=aw`, `scene_set=pure_coverage` | local | scratch | 0.4, pi/6 | 2026081602 | 500000 requested; replay cap 100000; screens every 100000 | RTX A6000 GPU1 | running; step100000 at 2026-08-06 12:32; learning gate failed: no-op/brake-in-place (mean a≈-0.32, speed 0), CV 0/2, collision 0 | `artifacts/2026-08-04_continuous_marl_refactor/p6_screening/p6_aw_500k_pure_coverage_20260805_*` | 100k 复盘见 8.2；继续 500k 数据积累，不晋级 |
